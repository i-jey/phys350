...
function setup() { 
    ...
    body1 = new body(800, 600, 7500000, 0, 0, 1); // BLUE
    body2 = new body(650, 600, 10000000, 0, 0, 2); // RED
    body3 = new body(800, 800, 10000000, 0, 3); // GREEN
}
...
function forceDirection(x1, y1, x2, y2, force) { 
    if(x1 < x2 && y1 < y2) { 
        return [force, force]; 
    }
    else if (x1 < x2 && y1 > y2) { 
